		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#sapbtpbuyingproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpbuyingproducts-display": {
								"semanticObject": "sapbtpbuyingproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.buyingproducts",
									"url": sap.ui.require.toUrl("sap/btp/buyingproducts")
								}
							}
						}
					}
